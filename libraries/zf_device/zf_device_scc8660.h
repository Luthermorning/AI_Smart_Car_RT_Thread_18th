...
// 摄像头默认参数配置 在此修改摄像头配置
//--------------------------------------------------------------------------------------------------
#define SCC8660_W               (180)                                           // 实际图像分辨率宽度 可选参数为：160 180
#define SCC8660_H               (160)                                           // 实际图像分辨率高度 可选参数为：120 160
...
#define SCC8660_BRIGHT_DEF      (80)                                           // 亮度设置     手动曝光默认：300   手动曝光时：参数范围0-65535   自动曝光推荐值：100 自动曝光时参数设置范围0-255
